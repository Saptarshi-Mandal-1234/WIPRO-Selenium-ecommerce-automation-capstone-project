    ...
    try:
        ...
        try:
            ...
            if "Logged in as" in driver.page_source:
                ...
                report.log("Login", "SKIP", "Login not confirmed, continuing as guest.", take_screenshot(driver, "02_login_not_confirmed"))
        ...
        if cart_details:
            report.log("Verify Cart Details", "PASS", "Cart contains: " + "; ".join(cart_details), take_screenshot(driver, "06_cart_verified"))
        else:
            report.log("Verify Cart Details", "FAIL", "Cart appears empty.", take_screenshot(driver, "06_cart_empty"))
